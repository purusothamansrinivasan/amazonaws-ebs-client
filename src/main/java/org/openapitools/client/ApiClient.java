...
public class ApiClient {
    ...
    protected String basePath = "http://ebs.us-east-1.amazonaws.com";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://ebs.{region}.amazonaws.com",
      "The Amazon EBS multi-region endpoint",
    ...
    new ServerConfiguration(
      "https://ebs.{region}.amazonaws.com",
      "The Amazon EBS multi-region endpoint",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    new ServerConfiguration(
      "http://ebs.{region}.amazonaws.com.cn",
      "The Amazon EBS endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
          "cn-north-1",
    ...
    new ServerConfiguration(
      "https://ebs.{region}.amazonaws.com.cn",
      "The Amazon EBS endpoint for China (Beijing) and China (Ningxia)",
      new HashMap<String, ServerVariable>() {{
        put("region", new ServerVariable(
          "The AWS region",
    ...
    protected void init() {
        ...
        setUserAgent("OpenAPI-Generator/2019-11-02/java");
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://ebs.us-east-1.amazonaws.com
