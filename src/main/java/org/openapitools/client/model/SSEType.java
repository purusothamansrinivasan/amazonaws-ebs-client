...
/**
 * Gets or Sets SSEType
 */
@JsonAdapter(SSEType.Adapter.class)
public enum SSEType {
  ...
  public static class Adapter extends TypeAdapter<SSEType> {
    @Override
    public void write(final JsonWriter jsonWriter, final SSEType enumeration) throws IOException {
      jsonWriter.value(enumeration.getValue());
    }

    @Override
    public SSEType read(final JsonReader jsonReader) throws IOException {
      String value = jsonReader.nextString();
      return SSEType.fromValue(value);
    }
  }

  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
    String value = jsonElement.getAsString();
    SSEType.fromValue(value);
  }
}
