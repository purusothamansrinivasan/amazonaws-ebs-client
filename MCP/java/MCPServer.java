...
// Import Get_Snapshots_Second_Snapshot_Id_ChangedblocksMCPTool - included in same package
// Import Get_Snapshots_Snapshot_Id_BlocksMCPTool - included in same package
// Import Post_SnapshotsMCPTool - included in same package
// Import Put_Snapshots_Snapshot_Id_Blocks_Block_Index_X_Amz_Data_Length_X_Amz_Checksum_X_Amz_Checksum_AlgorithmMCPTool - included in same package
// Import Get_Snapshots_Snapshot_Id_Blocks_Block_Index_Block_TokenMCPTool - included in same package
// Import Post_Snapshots_Completion_Snapshot_Id_X_Amz_Changed_Blocks_CountMCPTool - included in same package
...
public class MCPServer {
    ...
    public static void main(String[] args) {
        try {
            ...
            // Register all tools
            tools = Arrays.asList(
            Get_Snapshots_Second_Snapshot_Id_ChangedblocksMCPTool.createGet_Snapshots_Second_Snapshot_Id_ChangedblocksTool(config),
            Get_Snapshots_Snapshot_Id_BlocksMCPTool.createGet_Snapshots_Snapshot_Id_BlocksTool(config),
            Post_SnapshotsMCPTool.createPost_SnapshotsTool(config),
            Put_Snapshots_Snapshot_Id_Blocks_Block_Index_X_Amz_Data_Length_X_Amz_Checksum_X_Amz_Checksum_AlgorithmMCPTool.createPut_Snapshots_Snapshot_Id_Blocks_Block_Index_X_Amz_Data_Length_X_Amz_Checksum_X_Amz_Checksum_AlgorithmTool(config),
            Get_Snapshots_Snapshot_Id_Blocks_Block_Index_Block_TokenMCPTool.createGet_Snapshots_Snapshot_Id_Blocks_Block_Index_Block_TokenTool(config),
            Post_Snapshots_Completion_Snapshot_Id_X_Amz_Changed_Blocks_CountMCPTool.createPost_Snapshots_Completion_Snapshot_Id_X_Amz_Changed_Blocks_CountTool(config)
            );
